...
variable "present_topology" {
  description = "The preset topology for the hub. Options are 'MES' or 'STAR'."
  type        = string
  default     = "MESH"
...
variable "name" {
  description = "The name of the NCC hub - available optional are default, center, edge"
  type        = string
  default     = "default"
}

variable "trusted_projects" {
  description = "List of trusted projects that will be auto accepted in the NCC group"
  type        = list(string)
  default     = []
}

variable "spokes_location" {
  description = "The location of the spokes. Default is global."
  type        = string
  default     = "global"
